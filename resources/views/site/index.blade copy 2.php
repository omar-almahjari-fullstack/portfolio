                ...
                @foreach ($links as $l)
                    @php
                        ...
                        if (!$iconClass) {
                            ...
                            $name = strtolower(trim($iconClass));
                            $brands = ['facebook','twitter','instagram','linkedin','github','youtube','whatsapp','telegram'];
                            $prefix = in_array($name, $brands) ? 'fab' : 'fas';
                            $iconClass = $prefix . ' fa-' . $name;
                        }
                    @endphp
                    <a href="{{ $l->url ?? '#' }}" target="_blank"><i class="{{ $iconClass }}"></i></a>
                @endforeach
            </div>
        </div>
    </div>
